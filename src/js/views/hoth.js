...
useEffect(() => {
    fetch("https://www.swapi.tech/api/planets/4")
    ...
    <div className="card mb-3" style={textColor}>
      <div className="row g-0">
        <div className="col-md-4">
          <img
            src="https://cdn.domestika.org/c_fit,dpr_auto,f_auto,t_base_params,w_820/v1588454829/content-items/004/420/676/Annotazione_2020-05-02_232611-original.jpg?1588454829"
